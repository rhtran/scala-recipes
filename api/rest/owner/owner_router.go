...
import (
	...
	resterr "github.com/rhtran/go-rest-template/api/rest/errors"

	"github.com/gin-gonic/gin"
	"github.com/qiangxue/go-restful-api/pkg/log"
)

type OwnerServicer interface {
...
type OwnerRouter struct {
	logger  log.Logger
	service OwnerServicer
}

func NewOwnerRouter(logger log.Logger, service OwnerServicer) *OwnerRouter {
...
func (ownerRouter *OwnerRouter) OwnerRegister(router *gin.RouterGroup) {
	...
	router.GET(":id/pets", ownerRouter.allOwnersWithPets)
