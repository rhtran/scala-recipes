...
func NewOwnerService(logger log.Logger, repository OwnerRepositorier) *OwnerService {
	return &OwnerService{logger: logger, repository: repository}
}

func (service *OwnerService) GetOwnerById(id int) (*OwnerResponse, error) {
...
func (service *OwnerService) GetOwnerByLastName(lastName string) ([]OwnerResponse, error) {
...
func (service *OwnerService) GetAllOwners() ([]OwnerResponse, error) {
...
func (service *OwnerService) GetAllOwnersWithPets() ([]OwnerResponse, error) {
	service.logger.Info("retrieve all owner")
...
func (service *OwnerService) Create(owner *Owner) (*OwnerResponse, error) {
...
func (service *OwnerService) Update(owner *Owner) (*OwnerResponse, error) {
